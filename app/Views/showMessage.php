            ...
            <a href="/" class="menu-item nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                <a href="contact" class="menu-item nav-item nav-link"><i class="fa fa-phone me-2"></i>Contact Numbers</a>
                    <!-- <div class="nav-item dropdown"> -->
                        <a href="/sentMessage" class="menu-item nav-link ">
                            <i class="fa fa-envelope me-2"></i>Messages
                        </a>
                        <!-- <ul class="dropdown-menu dropdown-menu-start bg-secondary border-0 rounded-0 rounded-bottom m-0 ml-1" aria-labelledby="messagesDropdown">
                            <li class="messages" ><a href="messages" class="dropdown-item nav-link ml-5">Receive SMS</a></li>
                            <li class="messages" ><a href="sentMessage" class="dropdown-item nav-link ml-5">Sent SMS</a></li>
                        </ul>
                    </div> -->
